                ...
                <div className={` ${sCommon.container} ${s.portfolioContainer}`}>
                    ...
                    <div className={s.projects}>
                        ...
                        <Project title={'Maroon cosmetics'} description={'Simple draft HTML page. Study project' +
                            ' made using Figma'} style={maroonProject}
                                 projectHref={'https://katerinamiku.github.io/MaroonProject/index.html'}/>
                        <Project title={'Page for marketing company'} description={'Draft page for marketing company' +
                            ' services was made like a study project to learn Bootstrap'} style={visitPage}
                                 projectHref={'https://katerinamiku.github.io/bootstrapCite/index.html'}/>
